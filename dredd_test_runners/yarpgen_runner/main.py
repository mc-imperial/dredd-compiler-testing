...
def main():
    ...
    parser.add_argument("--use-sanitizers",
                        action="store_true",
                        help="If set, additionally compile and run each YARPGen-generated program with "
                             "ASan/UBSan and MSan, discarding the program if a sanitizer reports an error. "
                             "This guards against YARPGen occasionally emitting programs with undefined "
    ...
    with tempfile.TemporaryDirectory() as temp_dir_for_generated_code:
        ...
        while still_testing(total_test_time=args.total_test_time,
            ...
            # YARPGen occasionally emitting programs that feature undefined behaviour. Only done when
